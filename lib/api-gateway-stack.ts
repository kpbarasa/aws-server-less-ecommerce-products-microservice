...
export class ApiGatewayStack extends Construct {
    ...
    addResource(
        serviceName: string,
        { categoryService, productService, couponsService, imageService, queueService,}: ApiGatewayStackProps
    ) {
        ...
        this.createEndpoints(couponsService, apgw, {
            name: "coupons",
            methods: ["GET", "POST"],
            child: {
                name: "{id}",
